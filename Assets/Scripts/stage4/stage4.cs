...
public class stage4 : MonoBehaviour
{
    ...
    public void checkbill1()
    {
        ...
        {
            if (foodmenu[foodrandom1].foodname == takeingfood.foodname && takeingfood == salmonfood)
            {
                coin += 60;
                soundplay.PlayOneShot(checkbillsound);
            }
            else if (foodmenu[foodrandom1].foodname == takeingfood.foodname)
            {
                coin += 45;
                soundplay.PlayOneShot(checkbillsound);
            }
        ...
        else if (dish == 2)
        {
            ...
            if (foodmenu[foodrandom1].foodname == pot2st2.takeingfood2.foodname && pot2st2.takeingfood2 == salmonfood)
            {
                coin += 60;
                soundplay.PlayOneShot(checkbillsound);
            }
            else if (foodmenu[foodrandom1].foodname == pot2st2.takeingfood2.foodname)
            {
                coin += 45;
                soundplay.PlayOneShot(checkbillsound);
            }
        ...
        {
            if (foodmenu[foodrandom1].foodname == pannew.takeingfood3.foodname && pannew.takeingfood3 == salmonfood)
            {
                coin += 60;
                soundplay.PlayOneShot(checkbillsound);
            }
            else if (foodmenu[foodrandom1].foodname == pannew.takeingfood3.foodname)
            {
                coin += 45;
                soundplay.PlayOneShot(checkbillsound);
            }
