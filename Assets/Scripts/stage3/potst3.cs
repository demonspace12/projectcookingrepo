...
public class potst3 : MonoBehaviour
{
    public SpriteRenderer potmain2;
    public stage3 timerSC;
...

    {
        ...
        for (int i = 0; i < timerSC.foodmenu.Length; i++)
        {
            ...
            {
                if (pot_2[j].title == timerSC.foodmenu[i].Food_material_1 && pot2_material_1 == false)
                {
                    Debug.Log(timerSC.foodmenu[i].Food_material_1);
                    pot2_material_1 = true;
                    material_num2 += 1;
                }
                else if (pot_2[j].title == timerSC.foodmenu[i].Food_material_2 && pot2_material_2 == false)
                {
                    Debug.Log(timerSC.foodmenu[i].Food_material_2);
                    pot2_material_2 = true;
                    material_num2 += 1;
                }
                else if (pot_2[j].title == timerSC.foodmenu[i].Food_material_3 && pot2_material_3 == false)
                {
                    Debug.Log(timerSC.foodmenu[i].Food_material_3);
                    pot2_material_3 = true;
                    material_num2 += 1;
                }
                else if (pot_2[j].title == timerSC.foodmenu[i].Food_material_4 && pot2_material_4 == false)
                {
